...
use Roducks\Files\Config as Conf;

class Config extends Service {
  public function getSite($name = NULL)
  {
    $site = $name ?? App::getSite();
    return Conf::getSite($site);
  }

  public function getSiteModule($site, $module)
  {
    return Conf::getModule($site, $module);
  }

  public function getModule($name = NULL)
  {
    $module = $name ?? App::getModule();
    return $this->getSiteModule(App::getSite(), $module);
  }
}
